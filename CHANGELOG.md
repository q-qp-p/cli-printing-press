...
## [4.32.0](https://github.com/q-qp-p/cli-printing-press/compare/v4.31.1...v4.32.0) (2026-08-25)
...
* **catalog:** add Plane project-management catalog entry ([#2598](https://github.com/q-qp-p/cli-printing-press/issues/2598)) ([91245f6](https://github.com/q-qp-p/cli-printing-press/commit/91245f67e1cde1c0f319e8d552f4b2fc81524216))
* **catalog:** add shipping tracker blueprint ([#2649](https://github.com/q-qp-p/cli-printing-press/issues/2649)) ([4bfd960](https://github.com/q-qp-p/cli-printing-press/commit/4bfd960b73f96d0ec4c4935ab6059b0426427a47))
* **catalog:** add tidycal ([#2565](https://github.com/q-qp-p/cli-printing-press/issues/2565)) ([683d849](https://github.com/q-qp-p/cli-printing-press/commit/683d849c430ae25cd632873e33e88be1cf0a4738))
...
* **cli:** add BLE device-sniff and device-spec CLI generation ([#2601](https://github.com/q-qp-p/cli-printing-press/issues/2601)) ([4e0e8f8](https://github.com/q-qp-p/cli-printing-press/commit/4e0e8f845aaec9031cb3543aeec8190185d8aa96))
...
* **cli:** creator + contributors attribution model ([#2432](https://github.com/q-qp-p/cli-printing-press/issues/2432)) ([d7bf1bf](https://github.com/q-qp-p/cli-printing-press/commit/d7bf1bf2c0df9d497a7c19d0ae6ba34fa25dd5db))
...
* **cli:** port self-teaching loop into generator templates ([#2440](https://github.com/q-qp-p/cli-printing-press/issues/2440)) ([eb7ef10](https://github.com/q-qp-p/cli-printing-press/commit/eb7ef10deee696b7a962873b7d2c93a5b8d6b67e))
...
* **skills:** add currency-version floor that hard-blocks generation on stale binaries ([#2567](https://github.com/q-qp-p/cli-printing-press/issues/2567)) ([ef0ec66](https://github.com/q-qp-p/cli-printing-press/commit/ef0ec661c1d01618d61c39de72c1c33eb5e56083))
...
* **ci:** bump Go to 1.26.4 to clear GO-2026-5037 / GO-2026-5039 stdlib advisories ([#2612](https://github.com/q-qp-p/cli-printing-press/issues/2612)) ([a4fcff7](https://github.com/q-qp-p/cli-printing-press/commit/a4fcff797bb914fea6e9fd3d8608f0bc661b28f5))
...
* **ci:** raise Mergify max_parallel_checks to 5 and exclude draft PRs ([#2663](https://github.com/q-qp-p/cli-printing-press/issues/2663)) ([842f612](https://github.com/q-qp-p/cli-printing-press/commit/842f6126adf2c07460a7e786a0ff834b19cfbb40))
...
* **cli:** always emit RequestBaseURL() so novel commands keep BasePath ([#2520](https://github.com/q-qp-p/cli-printing-press/issues/2520)) ([6db6972](https://github.com/q-qp-p/cli-printing-press/commit/6db6972089b35c24e7071c7c5ed7c640c4b528a7))
...
* **cli:** annotate read-only framework MCP commands ([#2700](https://github.com/q-qp-p/cli-printing-press/issues/2700)) ([1b7129b](https://github.com/q-qp-p/cli-printing-press/commit/1b7129b8b954d0d8e65a274e98833b58e4ab9393))
...
* **cli:** apply store SQLite pragmas via modernc _pragma= DSN syntax ([#2399](https://github.com/q-qp-p/cli-printing-press/issues/2399)) ([d8b6b5f](https://github.com/q-qp-p/cli-printing-press/commit/d8b6b5f758bc979f1a361b9dd7121dcf4ae0d22a))
* **cli:** ASCII-fold in CamelIdentifier so non-ASCII names don't corrupt identifiers ([#2555](https://github.com/q-qp-p/cli-printing-press/issues/2555)) ([0c18120](https://github.com/q-qp-p/cli-printing-press/commit/0c1812055a5e674ffa495485f0b44eba502947ef))
...
* **cli:** auto-apply large MCP orchestration default ([#2365](https://github.com/q-qp-p/cli-printing-press/issues/2365)) ([0c7a263](https://github.com/q-qp-p/cli-printing-press/commit/0c7a26351fc125be92537618fe4f15d0b4906db3))
...
* **cli:** bound remote spec fetch with a timeout and size cap ([#2558](https://github.com/q-qp-p/cli-printing-press/issues/2558)) ([443d9ae](https://github.com/q-qp-p/cli-printing-press/commit/443d9aed6d6b66a5ec0848fe9784b5337062c0ea))
...
* **cli:** bump emitted go directive to 1.26.4 ([#2627](https://github.com/q-qp-p/cli-printing-press/issues/2627)) ([a21d796](https://github.com/q-qp-p/cli-printing-press/commit/a21d7969f2decf0efe47cd54cd6099087fe3d56f))
...
* **cli:** carry spec-declared query-param defaults into typed MCP bindings ([#2689](https://github.com/q-qp-p/cli-printing-press/issues/2689)) ([4a6d1fc](https://github.com/q-qp-p/cli-printing-press/commit/4a6d1fc0acc51239268b0858cf5b46fe2bc130f3))
...
* **cli:** dedup intentEndpoints map + 0600/0700 cache perms + cobratree shell-arg quoting ([#2697](https://github.com/q-qp-p/cli-printing-press/issues/2697)) ([dede887](https://github.com/q-qp-p/cli-printing-press/commit/dede887e828be33acbfa24364b12ad3bcaaf314a))
...
* **cli:** drop journal_mode from read-only store DSN ([#2407](https://github.com/q-qp-p/cli-printing-press/issues/2407)) ([4bf1659](https://github.com/q-qp-p/cli-printing-press/commit/4bf16593ef55fb5e11598d9558dbd9b770d91f3e))
...
* **cli:** emit GraphQL-aware import for GraphQL specs, not REST POST ([#2618](https://github.com/q-qp-p/cli-printing-press/issues/2618)) ([7ba6fb0](https://github.com/q-qp-p/cli-printing-press/commit/7ba6fb0af5abd25f445c22b1da5f56476c3c029f))
...
* **cli:** emit valid JSON for sync_warning events ([#2643](https://github.com/q-qp-p/cli-printing-press/issues/2643)) ([dec1fc9](https://github.com/q-qp-p/cli-printing-press/commit/dec1fc9336b0b8112381bb1339fcc9f41c663836))
...
* **cli:** exclude scalar-array and sampler endpoints from sync selection ([#2549](https://github.com/q-qp-p/cli-printing-press/issues/2549)) ([54ecd9e](https://github.com/q-qp-p/cli-printing-press/commit/54ecd9e5205012991335fd6096e8f29d2803f465))
...
* **cli:** filter raw HARs from publishable manuscripts ([#2525](https://github.com/q-qp-p/cli-printing-press/issues/2525)) ([a5f6e70](https://github.com/q-qp-p/cli-printing-press/commit/a5f6e70aff26e583fa23b8e2871356352c808eac))
...
* **cli:** gate novel-feature Help guard on positional + non-placeholder parent Short ([#2694](https://github.com/q-qp-p/cli-printing-press/issues/2694)) ([505998c](https://github.com/q-qp-p/cli-printing-press/commit/505998c1f05535285ba740857727d8ea07ab2adc))
...
* **cli:** gate sync search hint, dogfood-safe tail follow, 400 argument-missing warning ([#2702](https://github.com/q-qp-p/cli-printing-press/issues/2702)) ([68b47fd](https://github.com/q-qp-p/cli-printing-press/commit/68b47fd0fe0d7a6116ac6773bf46bcaf5e62f624))
...
* **cli:** gofmt Go source after publish-time module-path rewrite ([#2405](https://github.com/q-qp-p/cli-printing-press/issues/2405)) ([6183f1b](https://github.com/q-qp-p/cli-printing-press/commit/6183f1b271be92d1dca92acd996ad383d8bfb8c6))
* **cli:** guard empty PROXY_ARGS expansion under bash 3.2 ([#2439](https://github.com/q-qp-p/cli-printing-press/issues/2439)) ([ad28280](https://github.com/q-qp-p/cli-printing-press/commit/ad282805a9523a8f52e2209cec600aa9b03caad9)), closes [#2438](https://github.com/q-qp-p/cli-printing-press/issues/2438)
...
* **cli:** handle reserved search resources ([#2360](https://github.com/q-qp-p/cli-printing-press/issues/2360)) ([ef0cd96](https://github.com/q-qp-p/cli-printing-press/commit/ef0cd963e03425ca1a664d77b3282d9709badc7f))
...
* **cli:** honor explicit has_more:false in sync page-int fallback + add metadata envelope key ([#2696](https://github.com/q-qp-p/cli-printing-press/issues/2696)) ([b5f7fe3](https://github.com/q-qp-p/cli-printing-press/commit/b5f7fe33afd468c4715b853353a48d737ed562f8))
...
* **cli:** ignore scalar siblings in sync envelope fallback ([#2532](https://github.com/q-qp-p/cli-printing-press/issues/2532)) ([2f9fb81](https://github.com/q-qp-p/cli-printing-press/commit/2f9fb81b70a69d77d6778fda4e9c5290b535ec0f))
...
* **cli:** inject MCP server version via ldflag instead of hardcoded 1.0.0 ([#2699](https://github.com/q-qp-p/cli-printing-press/issues/2699)) ([d0ae8dc](https://github.com/q-qp-p/cli-printing-press/commit/d0ae8dc1b36e13c0f10e5943df2947369ea99270))
...
* **cli:** keep defaulted high-frequency query params in global filter ([#2678](https://github.com/q-qp-p/cli-printing-press/issues/2678)) ([a12e75c](https://github.com/q-qp-p/cli-printing-press/commit/a12e75ca8f734ce2d81079e79ec7218633f32e0e))
...
* **cli:** keep sole query input param from global-param filter ([#2241](https://github.com/q-qp-p/cli-printing-press/issues/2241)) ([518b3eb](https://github.com/q-qp-p/cli-printing-press/commit/518b3ebd982185fafa085370c2732fd793f288ee)), closes [#982](https://github.com/q-qp-p/cli-printing-press/issues/982)
...
* **cli:** live dogfood happy-path honors pp:happy-args ([#2642](https://github.com/q-qp-p/cli-printing-press/issues/2642)) ([d2ca5a2](https://github.com/q-qp-p/cli-printing-press/commit/d2ca5a2cb3f31423658314340149d0cb05f2c86a))
...
* **cli:** normalize publish package metadata ([#2523](https://github.com/q-qp-p/cli-printing-press/issues/2523)) ([79c7c82](https://github.com/q-qp-p/cli-printing-press/commit/79c7c82d249b16487c2742a1937787949573f298))
...
* **cli:** parse comment-led helper call files ([#2524](https://github.com/q-qp-p/cli-printing-press/issues/2524)) ([0cfc64b](https://github.com/q-qp-p/cli-printing-press/commit/0cfc64bc11dbfae6cf70e929e18ce231addfd1e3))
* **cli:** parse multiline GraphQL fields for promoted resources ([#2367](https://github.com/q-qp-p/cli-printing-press/issues/2367)) ([26edea9](https://github.com/q-qp-p/cli-printing-press/commit/26edea9434622383f44a83e74a12bc794f361231))
...
* **cli:** pass --db to data-pipeline sql probes and WARN-skip the sync gate for pure-API CLIs ([#2691](https://github.com/q-qp-p/cli-printing-press/issues/2691)) ([a856a73](https://github.com/q-qp-p/cli-printing-press/commit/a856a7384263eb5e963c62980a7eaf549ccb6051))
* **cli:** pass context to async job no-cache polling ([#2456](https://github.com/q-qp-p/cli-printing-press/issues/2456)) ([1872817](https://github.com/q-qp-p/cli-printing-press/commit/1872817ad58713d24cd86921892a4b6d08e50995))
...
* **cli:** pin golang.org/x/net to a patched version after generation ([#2410](https://github.com/q-qp-p/cli-printing-press/issues/2410)) ([470bd19](https://github.com/q-qp-p/cli-printing-press/commit/470bd19d417f8276b0396e334d52dd38576e1285))
...
* **cli:** platform-conditional --help validation timeout + accurate pipeline.Init doc ([#2695](https://github.com/q-qp-p/cli-printing-press/issues/2695)) ([3166d73](https://github.com/q-qp-p/cli-printing-press/commit/3166d73fecd4092b0cfc4c88d7b1a70b9f1ce0ae))
* **cli:** prefer Chrome profiles with auth cookies ([#2681](https://github.com/q-qp-p/cli-printing-press/issues/2681)) ([067e947](https://github.com/q-qp-p/cli-printing-press/commit/067e9476b165083f681bc7f51bd3aa2dcb826ed1))
...
* **cli:** preserve creator attribution on reprint ([#2634](https://github.com/q-qp-p/cli-printing-press/issues/2634)) ([4e261dc](https://github.com/q-qp-p/cli-printing-press/commit/4e261dca6d6e40a447a0a1685de5bc817210676a))
...
* **cli:** preserve live dogfood refresh credentials ([#2638](https://github.com/q-qp-p/cli-printing-press/issues/2638)) ([29aba15](https://github.com/q-qp-p/cli-printing-press/commit/29aba15f6bc78f1a38b1a159f5b83fa7b34313d7))
...
* **cli:** preserve manifest spec name in transient mcp-sync dirs ([#2698](https://github.com/q-qp-p/cli-printing-press/issues/2698)) ([c36f8b4](https://github.com/q-qp-p/cli-printing-press/commit/c36f8b46eb2b78039d77b90751aa73057054c6eb))
...
* **cli:** preserve module imports on force regen ([#2531](https://github.com/q-qp-p/cli-printing-press/issues/2531)) ([e3801c7](https://github.com/q-qp-p/cli-printing-press/commit/e3801c7b489936975d15f9e00a9306f2b467fdb1))
...
* **cli:** preserve nested compact list payloads ([#2752](https://github.com/q-qp-p/cli-printing-press/issues/2752)) ([5478daa](https://github.com/q-qp-p/cli-printing-press/commit/5478daa05ccc9a0fe076367059117ea9fe6a7b72))
...
* **cli:** preserve sync cursor on max-pages cap ([#2543](https://github.com/q-qp-p/cli-printing-press/issues/2543)) ([f7037d8](https://github.com/q-qp-p/cli-printing-press/commit/f7037d8a4bef4117b72e29f07d1f4624978f58de))
...
* **cli:** preserve typed tables for paginated union resources ([#2540](https://github.com/q-qp-p/cli-printing-press/issues/2540)) ([5b0efb8](https://github.com/q-qp-p/cli-printing-press/commit/5b0efb87bce9f01dc91eb54d123ed0d8362238a9))
...
* **cli:** promote global path template vars ([#2366](https://github.com/q-qp-p/cli-printing-press/issues/2366)) ([3824012](https://github.com/q-qp-p/cli-printing-press/commit/3824012af97ca8abcaadc30deec3fe141fa9dcbb))
...
* **cli:** re-inject lost registrations into their source function ([#2559](https://github.com/q-qp-p/cli-printing-press/issues/2559)) ([288b4a5](https://github.com/q-qp-p/cli-printing-press/commit/288b4a5d584ef93fcb35e3e19adf5590486c68be))
* **cli:** rebuild FTS after rowid migration ([#2542](https://github.com/q-qp-p/cli-printing-press/issues/2542)) ([79c8acf](https://github.com/q-qp-p/cli-printing-press/commit/79c8acf3661a9bee030adfa46fe10c5e27812e52))
...
* **cli:** recognize Google "Login Required" 401 envelope and rebuild staged binary in dogfood --live ([#2690](https://github.com/q-qp-p/cli-printing-press/issues/2690)) ([991c35d](https://github.com/q-qp-p/cli-printing-press/commit/991c35d6136b35708a375a97a7e98a24677dfae8))
...
* **cli:** redact token= credentials + accurate SQL tool schema description ([#2701](https://github.com/q-qp-p/cli-printing-press/issues/2701)) ([aee10fa](https://github.com/q-qp-p/cli-printing-press/commit/aee10fac925535243a4ecd8af2ac67cf5d8c2f5d))
...
* **cli:** reject missing analytics group-by fields ([#2751](https://github.com/q-qp-p/cli-printing-press/issues/2751)) ([bfe4759](https://github.com/q-qp-p/cli-printing-press/commit/bfe4759f82ddc534c7364ff1662d548462e250c8))
...
* **cli:** require explicit global scope flags ([#2530](https://github.com/q-qp-p/cli-printing-press/issues/2530)) ([6f5518f](https://github.com/q-qp-p/cli-printing-press/commit/6f5518f963fbdda977b524e1c53d42a1b577dfa9))
...
* **cli:** resolve GraphQL custom root operation types ([#2556](https://github.com/q-qp-p/cli-printing-press/issues/2556)) ([b0b4147](https://github.com/q-qp-p/cli-printing-press/commit/b0b41473ed9c4b27a61ee550d4e04ee6cf653d3f))
...
* **cli:** scorer multi-spec path_validity + docsync novel-feature Go-surface resync and drop-warning ([#2693](https://github.com/q-qp-p/cli-printing-press/issues/2693)) ([298c46f](https://github.com/q-qp-p/cli-printing-press/commit/298c46fdba1b5b24d68041074638da8c4aa58894))
...
* **cli:** skip unsynced local live-check samples ([#2533](https://github.com/q-qp-p/cli-printing-press/issues/2533)) ([50c4504](https://github.com/q-qp-p/cli-printing-press/commit/50c450472491456117ddd89b72b6c5f5865ffbdf))
...
* **cli:** stop gating promote on ASIN examples ([#2522](https://github.com/q-qp-p/cli-printing-press/issues/2522)) ([6bfd1be](https://github.com/q-qp-p/cli-printing-press/commit/6bfd1be3f2f770a0cd3c13489cf098e4f4677c0d))
...
* **cli:** strip *.test on publish, dedup -pp slug, crowd-sniff drop summary ([#2703](https://github.com/q-qp-p/cli-printing-press/issues/2703)) ([2051f56](https://github.com/q-qp-p/cli-printing-press/commit/2051f5681f46954979c797e6c4769247bcc350a1))
...
* **cli:** support standalone pycookiecheat ([#2725](https://github.com/q-qp-p/cli-printing-press/issues/2725)) ([3d70c16](https://github.com/q-qp-p/cli-printing-press/commit/3d70c169ef8c240257ca1f925489d4e86e05769e))
...
* **cli:** surface row errors in generated MCP sql tool ([#2650](https://github.com/q-qp-p/cli-printing-press/issues/2650)) ([2af370c](https://github.com/q-qp-p/cli-printing-press/commit/2af370c7525c45be9bff818dc018988a387b9b8b))
...
* **cli:** trim client credential env vars for auth login ([#2537](https://github.com/q-qp-p/cli-printing-press/issues/2537)) ([2742ef7](https://github.com/q-qp-p/cli-printing-press/commit/2742ef7aa36d911c5ec53847ebd29f0fcb53eeb0))
...
* **generator:** emit toolchain floor and pin validate govulncheck to module toolchain ([#2709](https://github.com/q-qp-p/cli-printing-press/issues/2709)) ([7f6382d](https://github.com/q-qp-p/cli-printing-press/commit/7f6382d4049f389954d5681b8eb1c50eb8324275))
...
* **generator:** JSON-safe GraphQL sync_warning/sync_error events ([#2675](https://github.com/q-qp-p/cli-printing-press/issues/2675)) ([#2715](https://github.com/q-qp-p/cli-printing-press/issues/2715)) ([ffeb210](https://github.com/q-qp-p/cli-printing-press/commit/ffeb210dda7ea2ec60ede9e54af241bac4e9b90a))
...
* **generator:** quote local FTS search terms ([#2755](https://github.com/q-qp-p/cli-printing-press/issues/2755)) ([b36d1aa](https://github.com/q-qp-p/cli-printing-press/commit/b36d1aa633ea719bca69d00ef851e5682eefca77))
...
* **generator:** rely on installer default bin directory ([#2654](https://github.com/q-qp-p/cli-printing-press/issues/2654)) ([0a9969c](https://github.com/q-qp-p/cli-printing-press/commit/0a9969cc3c32313a04c6c27cebb36b79b8a0b42a))
* **generator:** resolve three silent sync data-loss paths ([#2327](https://github.com/q-qp-p/cli-printing-press/issues/2327), [#2569](https://github.com/q-qp-p/cli-printing-press/issues/2569), [#2621](https://github.com/q-qp-p/cli-printing-press/issues/2621)) ([#2713](https://github.com/q-qp-p/cli-printing-press/issues/2713)) ([adc9f51](https://github.com/q-qp-p/cli-printing-press/commit/adc9f51f147f6a5926bf52072526a7ce87ed1f02))
* **generator:** rewrite bare-root self-imports on publish --module-path ([#2578](https://github.com/q-qp-p/cli-printing-press/issues/2578)) ([#2721](https://github.com/q-qp-p/cli-printing-press/issues/2721)) ([a85d722](https://github.com/q-qp-p/cli-printing-press/commit/a85d722ab65c03ffafb3ff3ba657b112ba7f1387))
...
* **generator:** surface row + query errors in store ResolveByName ([#2708](https://github.com/q-qp-p/cli-printing-press/issues/2708)) ([#2716](https://github.com/q-qp-p/cli-printing-press/issues/2716)) ([1539622](https://github.com/q-qp-p/cli-printing-press/commit/1539622844da493089560d72af610d2a5c3253b3))
* **generator:** treat null resource array with zero count as an empty sync page ([#2656](https://github.com/q-qp-p/cli-printing-press/issues/2656)) ([#2719](https://github.com/q-qp-p/cli-printing-press/issues/2719)) ([826432a](https://github.com/q-qp-p/cli-printing-press/commit/826432a2d2cb5021f9608874023346e408c13455))
...
* **patches:** emit per-patch directory layout (generator + skills) ([#2581](https://github.com/q-qp-p/cli-printing-press/issues/2581)) ([a826d31](https://github.com/q-qp-p/cli-printing-press/commit/a826d31617d635c8fd7717e9edf0ebf213797af0))
...
* **scorer:** SKIP data-pipeline gate for no-sync and local-datastore CLIs ([#2622](https://github.com/q-qp-p/cli-printing-press/issues/2622), [#2672](https://github.com/q-qp-p/cli-printing-press/issues/2672)) ([#2717](https://github.com/q-qp-p/cli-printing-press/issues/2717)) ([748da72](https://github.com/q-qp-p/cli-printing-press/commit/748da7244fd5f716f62c3677971ca74a505d3ebc))
* **scorer:** strip shipcheck report JSON on publish package ([#2658](https://github.com/q-qp-p/cli-printing-press/issues/2658)) ([#2718](https://github.com/q-qp-p/cli-printing-press/issues/2718)) ([a5e1929](https://github.com/q-qp-p/cli-printing-press/commit/a5e19298897babf407069fca4673e565888d2899))
* **skill:** align novel-command skeleton with generator's newNovel&lt;X&gt;Cmd scaffold ([#2704](https://github.com/q-qp-p/cli-printing-press/issues/2704)) ([53a59ee](https://github.com/q-qp-p/cli-printing-press/commit/53a59ee63523efeddfff10d6951cbd7c9c5f8f6b))
...
* **skills:** route rebuilt-novel reprints through swap ([#2527](https://github.com/q-qp-p/cli-printing-press/issues/2527)) ([c7ff7f8](https://github.com/q-qp-p/cli-printing-press/commit/c7ff7f80e79b807dcdd58e50aede3cc7563ebfd6))
* **skills:** update polish gosec fallback pin ([#2529](https://github.com/q-qp-p/cli-printing-press/issues/2529)) ([9548233](https://github.com/q-qp-p/cli-printing-press/commit/95482338b05ec15a04a01840782075966b11c9dd))
